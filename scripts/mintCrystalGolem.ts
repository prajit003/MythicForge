...
const METADATA_URI =
  "ipfs://bafkreigviylsp7sycvyra6j37qii5vgucsemvxm4ytp6a7ztldcf6ztgrm";

async function main() {
  console.log("Starting Crystal Golem mint...");
  ...
  console.log("\nMinting Crystal Golem...");

  const tx = await gameCard.mintCard(
    "Crystal Golem",
    "A massive guardian forged from ancient crystal and stone.",
    "Rare",
    70,
    95,
    METADATA_URI
  ...
  console.log("Crystal Golem minted successfully!");

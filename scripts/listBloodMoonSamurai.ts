...
// Blood Moon Samurai listing price
const PRICE_ETH = "0.010";

async function main() {

  console.log("Starting Blood Moon Samurai listing...");
  ...
  if (
    ...
    throw new Error(
      "You do not own Blood Moon Samurai (#9)."
    );
  }
  ...
  console.log(
    `\nListing Blood Moon Samurai for ${PRICE_ETH} ETH...`
  );
  ...
  console.log(
    "\nBlood Moon Samurai listed successfully!"
  );
  ...
  console.log(
    "\nBlood Moon Samurai (#9) is now available on the marketplace!"
  );
}

...
// Frost Titan listing price
const PRICE_ETH = "0.015";

async function main() {

  console.log("Starting Frost Titan listing...");
  ...
  console.log(
    `\nListing Frost Titan for ${PRICE_ETH} ETH...`
  );
  ...
  console.log(
    "\nFrost Titan listed successfully!"
  );
  ...
  console.log(
    "\nFrost Titan (#7) is now available on the marketplace!"
  );
}

...
const METADATA_URI =
  "ipfs://bafkreieclu2drw452ut3svi47ue55qpdpyvdcaldjvimoa5k5xllfedehy";

async function main() {

  console.log("Starting Thunder Beast mint...");
  ...
  console.log("\nMinting Thunder Beast...");

  const tx = await gameCard.mintCard(
    "Thunder Beast",
    "A fearsome beast charged with the power of the storm, striking its enemies with devastating lightning and unstoppable force.",
    "Rare",
    92,
    78,
    METADATA_URI
  ...
  console.log("Thunder Beast minted successfully!");

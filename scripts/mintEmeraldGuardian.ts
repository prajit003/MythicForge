...
const METADATA_URI =
  "ipfs://bafkreias62iw33xlqzqtc7pyv5mtjdjd34m2l6xuzmzescz3enjdanz3e4";

async function main() {

  console.log("Starting Emerald Guardian mint...");
  ...
  console.log("\nMinting Emerald Guardian...");

  const tx = await gameCard.mintCard(
    "Emerald Guardian",
    "An ancient guardian of the emerald realms, protected by enchanted roots and powerful crystals that channel the magic of nature.",
    "Legendary",
    84,
    97,
    METADATA_URI
  ...
  console.log("Emerald Guardian minted successfully!");
